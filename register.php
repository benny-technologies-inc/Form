        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="tex.php" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" name="password1" id="exampleRepeatPassword" placeholder="Repeat Password">
                  </div>
                </div>
